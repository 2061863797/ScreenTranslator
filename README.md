...
| 方式 | 说明 |
|------|------|
| **① Release 压缩包（推荐）** | 打开本仓库 **[Releases](../../releases)**，下载 `runtime-*.zip`，**解压到项目根目录**，得到完整 `runtime\`（models / llama / paddlex） |
...
| **runtime 大文件** | `models` / `llama` / `paddlex` | **仅 Release 附件 zip**（约 2GB），不进 Git |
