...
| 模板与文档 | `config.example.json`、`README.md` / `README.en.md`、`SETTINGS.en.md`、`runtime/README*.md`、`LLAMA启动器说明.md`、`icon.ico` | |
| llama 玩玩入口 | `启动llama.bat` → `runtime/llama/llama启动.exe` | 仅起 server，见 `LLAMA启动器说明.md` |
